...
COMMIT;
 ...
 Values
   (GN_LIST_OF_VALUES_S.nextval, 'HR_ASN_TERM_PERSONS_VS', 'I', 'ENTITY_ID = P_ENTITY_ID', 2, 
    ...
    '(SELECT HR_GENERAL_PKG.ASSIGNMENT_NUMBER_ASG_ID (ASSIGNMENT_ID) ASSIGNMENT_NUMBER ,PERSON_NAME FULL_NAME ,ENTITY_ID FROM TAT_PERSONS_V)', 1, 17, TO_DATE('11/7/2022 1:50:08 PM', 'MM/DD/YYYY HH:MI:SS AM'), 17, 
