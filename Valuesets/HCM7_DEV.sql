 ...
 Values
   (816, 'ELEMENT_NAMES_PRCROLES_VS', 'I', '1=1', 3, 
    ...
    '(SELECT ELEMENT_TYPE_ID,   
       ELEMENT_NAME,   
        ENTITY_ID  
  FROM PAY_ELEMENT_TYPES_V  WHERE INDIRECT_RESULT_FLAG=''Y''         
...
Insert into GN_LIST_OF_VALUES_T
   (LOV_ID, LOV_NAME, LOV_TYPE, LOV_QUERY, NO_OF_COL, 
    ...
    LAST_UPDATE_DATE, ACTIVE, ADF_FLAG, SORT_VALUE, CUSTOMIZATION_LEVEL)
 Values
   (1011, 'PAY_ELG_INPUT_VALUES_VS', 'I', '1=1', 3, 
    'INPUT_VALUE_ID', 'INPUT_NAME', 'ELEMENT_TYPE_ID', NULL, NULL, 
    '(select * from PAY_INPUT_VALUES_T where INPUT_DIRECTION NOT LIKE ''%O%'')', 1, -1, TO_DATE('12/14/2022 7:53:10 PM', 'MM/DD/YYYY HH:MI:SS AM'), -1, 
    TO_DATE('12/14/2022 8:00:55 PM', 'MM/DD/YYYY HH:MI:SS AM'), NULL, 'Y', 'M', 'S');
COMMIT;



15/12/2022
UPDATE  GN_LIST_OF_VALUES_T SET LOV_QUERY ='ENTITY_ID IN (SELECT ENTITY_ID  from GN_USERS_PAYROLLS_T where user_id=GN_GLOBAL_PKG.USER_ID)' WHERE LOV_NAME = 'ENTITIES_VS';
COMMIT;
 ...
 Insert into GN_LIST_OF_VALUES_T
   (LOV_ID, LOV_NAME, LOV_TYPE, LOV_QUERY, NO_OF_COL, 
    ...
    LAST_UPDATE_DATE, ACTIVE, ADF_FLAG, SORT_VALUE, CUSTOMIZATION_LEVEL)
 Values
   (1112, 'ALL_ENTITIES_VS', 'I', '1=1', 2, 
    'ENTITY_ID', 'ENTITY_NAME', NULL, NULL, NULL, 
    'HR_ENTITIES_V_A', NULL, -1, TO_DATE('5/16/2021 12:32:53 PM', 'MM/DD/YYYY HH:MI:SS AM'), 18, 
    TO_DATE('12/15/2022 2:59:12 PM', 'MM/DD/YYYY HH:MI:SS AM'), NULL, 'Y', 'M', 'S');
COMMIT;
 ...
 Insert into GN_LIST_OF_VALUES_T
   (LOV_ID, LOV_NAME, LOV_TYPE, LOV_QUERY, NO_OF_COL, 
    ...
    LAST_UPDATE_DATE, ACTIVE, ADF_FLAG, SORT_VALUE, CUSTOMIZATION_LEVEL)
 Values
   (1113, 'VALUESETS_LOOKUPS_VS', 'I', '1=1', 2, 
    'LOV_NAME', 'LOV_NAME', NULL, NULL, NULL, 
    '(SELECT LOV_NAME LOV_NAME FROM GN_LIST_OF_VALUES_T UNION ALL SELECT LOOKUP_TYPE LOV_NAME FROM GN_LOOKUP_TYPES_T)', 1, -1, TO_DATE('12/15/2022 8:03:11 PM', 'MM/DD/YYYY HH:MI:SS AM'), -1, 
    TO_DATE('12/15/2022 8:05:15 PM', 'MM/DD/YYYY HH:MI:SS AM'), NULL, 'Y', 'M', 'S');
COMMIT;
 ...
 Insert into GN_LIST_OF_VALUES_T
   (LOV_ID, LOV_NAME, LOV_TYPE, LOV_QUERY, NO_OF_COL, 
    ...
    LAST_UPDATE_DATE, ACTIVE, ADF_FLAG, SORT_VALUE, CUSTOMIZATION_LEVEL)
 Values
   (GN_LIST_OF_VALUES_S.nextval, 'PAY_ELM_WITH_FREQ_VS', 'I', 'NVL (INDIRECT_RESULT_FLAG, ''N'') = ''N'' AND  NVL(RETROPAY_ELE_ADJUSTMENT_FLAG,''N'')=''N'' AND (ELEMENT_TYPE_ID,ENTITY_ID) NOT IN ( SELECT ELEMENT_TYPE_ID , ENTITY_ID FROM HR_PAY_BASES_T ) ORDER BY ELEMENT_NAME', 3, 
    'ELEMENT_TYPE_ID', 'ELEMENT_NAME||''-''||  HR_GENERAL_PKG.DECODE_LOOKUP (''FREQUENCY'',
                                        CLASSIFICATION_ID) ', 'ENTITY_ID', NULL, NULL, 
...
COMMIT;
 ...
 Insert into GN_LIST_OF_VALUES_T
   (LOV_ID, LOV_NAME, LOV_TYPE, LOV_QUERY, NO_OF_COL, 
    ...
    LAST_UPDATE_DATE, ACTIVE, ADF_FLAG, SORT_VALUE, CUSTOMIZATION_LEVEL)
 Values
   (GN_LIST_OF_VALUES_S.nextval, 'HR_ASN_TERM_PERSONS_VS', 'I', 'ENTITY_ID = P_ENTITY_ID', 2, 
    'ASSIGNMENT_NUMBER', 'ASSIGNMENT_NUMBER || '' - '' || FULL_NAME', NULL, NULL, NULL, 
    '(SELECT DISTINCT  HR_GENERAL_PKG.ASSIGNMENT_NUMBER_ASG_ID (ASSIGNMENT_ID) ASSIGNMENT_NUMBER ,PERSON_NAME FULL_NAME ,ENTITY_ID FROM TAT_PERSONS_V)', 1, 17, TO_DATE('11/7/2022 1:50:08 PM', 'MM/DD/YYYY HH:MI:SS AM'), 17, 
    TO_DATE('12/6/2022 7:44:42 PM', 'MM/DD/YYYY HH:MI:SS AM'), 'Y', 'Y', 'M', 'S');
    commit;
...
Insert into GN_LIST_OF_VALUES_T
   (LOV_ID, LOV_NAME, LOV_TYPE, LOV_QUERY, NO_OF_COL, 
    ...
    LAST_UPDATE_DATE, ACTIVE, ADF_FLAG, SORT_VALUE, CUSTOMIZATION_LEVEL)
 Values
   (GN_LIST_OF_VALUES_S.nextval, 'PAY_BALANCE_DIMINSION_VS', 'I', ' (((       
        ENTITY_ID = P_ENTITY_ID         
        AND 
        GN_GLOBAL_PKG.USER_ID <> 1       
    )OR LEGISLATION_CODE = (SELECT COUNTRY_CODE FROM HR_ENTITIES_T WHERE ENTITY_ID = P_ENTITY_ID)       
)OR GN_GLOBAL_PKG.USER_ID = 1)', 3, 
    'BALANCE_DIMENSION_ID', 'DIMENSION_NAME', 'DATABASE_ITEM_SUFFIX', NULL, NULL, 
    '(SELECT DISTINCT ENTITY_ID,BALANCE_DIMENSION_ID BALANCE_DIMENSION_ID, DATABASE_ITEM_SUFFIX, DIMENSION_NAME,LEGISLATION_CODE FROM PAY_BALANC_DIMENSION_SETUP_V_A)         
', NULL, -1, TO_DATE('11/27/2022 7:25:19 PM', 'MM/DD/YYYY HH:MI:SS AM'), -1, 
    TO_DATE('11/27/2022 7:42:28 PM', 'MM/DD/YYYY HH:MI:SS AM'), NULL, 'Y', 'M', 'S');
...
Insert into GN_LIST_OF_VALUES_T
   (LOV_ID, LOV_NAME, LOV_TYPE, LOV_QUERY, NO_OF_COL, 
    ...
    LAST_UPDATE_DATE, ACTIVE, ADF_FLAG, SORT_VALUE, CUSTOMIZATION_LEVEL)
 Values
   (GN_LIST_OF_VALUES_S.nextval, 'PAY_ELE_CLASSIFICATIONS_VS', 'I', 'vv.LEGISLATION_CODE = en.COUNTRY_CODE   
ORDER BY 1 asc', 3, 
    'CLASSIFICATION_ID
', 'CLASSIFICATION_NAME', 'en.ENTITY_ID        ', NULL, NULL, 
    'PAY_ELEMENT_CLASSIFICATIONS_V vv,HR_ENTITIES_T   en  
', NULL, 17, TO_DATE('11/28/2022 6:04:40 PM', 'MM/DD/YYYY HH:MI:SS AM'), 17, 
    TO_DATE('11/28/2022 6:21:18 PM', 'MM/DD/YYYY HH:MI:SS AM'), NULL, 'Y', 'M', 'S');
COMMIT;end;
...
Insert into GN_LIST_OF_VALUES_T
   (LOV_ID, LOV_NAME, LOV_TYPE, LOV_QUERY, NO_OF_COL, 
    ...
    LAST_UPDATE_DATE, ACTIVE, ADF_FLAG, SORT_VALUE, CUSTOMIZATION_LEVEL)
 Values
   (1116, 'PAY_FORMULAS_VS', 'I', 'nvl(effective_end_date,''31-Dec-4712'') = ''31-Dec-4712''
and formula_type_id=3 ', 3, 
    'formula_id', 'FORMULA_NAME', 'ENTITY_ID', NULL, NULL, 
    'PAY_FORMULAS_T', NULL, 711, TO_DATE('11/16/2022 5:56:50 PM', 'MM/DD/YYYY HH:MI:SS AM'), -1, 
...
Insert into GN_LIST_OF_VALUES_T
   (LOV_ID, LOV_NAME, LOV_TYPE, LOV_QUERY, NO_OF_COL, 
    ...
    LAST_UPDATE_DATE, ACTIVE, ADF_FLAG, SORT_VALUE, CUSTOMIZATION_LEVEL)
 Values
   (807, 'FEED_TYPE_VS', 'I', '1=1', 4, 
    'FEED_TYPE_ID', 'FEED_NAME', 'ENTITY_ID', 'feed_type', NULL, 
    '(SELECT ''E'' as feed_type,ELEMENT_TYPE_ID AS FEED_TYPE_ID, ELEMENT_NAME AS FEED_NAME ,ENTITY_ID FROM PAY_ELEMENT_TYPES_V_A WHERE  EFFECTIVE_END_DATE = ''31-DEC-4712'' AND ''E'' =''E''    
UNION SELECT ''A'' as feed_type,ABSENCE_TYPE_ID AS FEED_TYPE_ID,ABSENSE_TYPE AS FEED_NAME,ENTITY_ID           
  FROM AMS_ABSENCE_MGT_HEADER_T            
 WHERE ''A''  =''A''    
       AND SYSDATE BETWEEN eff_start_dae            
                       AND NVL (EFF_END_DATE, ''31-DEC-4712'')            
 ORDER BY 2)', NULL, -1, TO_DATE('11/17/2022 12:07:56 PM', 'MM/DD/YYYY HH:MI:SS AM'), -1, 
    TO_DATE('12/21/2022 8:39:48 PM', 'MM/DD/YYYY HH:MI:SS AM'), NULL, 'Y', 'M', 'S');
COMMIT;
>>>>>>>>>>>>>>>>>>>>>>>>>>.
...
Insert into GN_LIST_OF_VALUES_T
   (LOV_ID, LOV_NAME, LOV_TYPE, LOV_QUERY, NO_OF_COL, 
    ...
    LAST_UPDATE_DATE, ACTIVE, ADF_FLAG, SORT_VALUE, CUSTOMIZATION_LEVEL)
 Values
   (1117, 'PAY_ELEMENT_ENTRIES_VS', 'I', 'ASSIGNMENT_ID = P_ASSIGNMENT_ID', 3, 
    'ELEMENT_ENTRY_ID', 'ELEMENT_ENTRY_ID', 'ELEMENT_TYPE_ID', NULL, NULL, 
    'PAY_ELEMENT_ENTRIES_T', NULL, 17, TO_DATE('11/24/2022 4:17:39 PM', 'MM/DD/YYYY HH:MI:SS AM'), -1, 
    TO_DATE('12/21/2022 8:39:48 PM', 'MM/DD/YYYY HH:MI:SS AM'), NULL, 'Y', 'M', 'S');
COMMIT;
