...
Insert into GN_LIST_OF_VALUES_T
   (LOV_ID, LOV_NAME, LOV_TYPE, LOV_QUERY, NO_OF_COL, 
    ...
    LAST_UPDATE_DATE, ACTIVE, ADF_FLAG, SORT_VALUE, CUSTOMIZATION_LEVEL)
 Values
   (810, 'HR_ALL_SITES_VS', 'I', ' NVL(HR_GENERAL_PKG.DECODE_SITE(site_id) ,''0'') <> ''0''', 2, 
    'site_id', 'HR_GENERAL_PKG.DECODE_SITE(site_id)', NULL, NULL, NULL, 
    'hr_sites_t', 1, -1, TO_DATE('11/21/2022 2:08:53 PM', 'MM/DD/YYYY HH:MI:SS AM'), -1, 
    TO_DATE('11/21/2022 2:17:08 PM', 'MM/DD/YYYY HH:MI:SS AM'), NULL, 'Y', 'M', 'S');
COMMIT;